  ...
  var data = [
    {
      domain: { x: [0, 1], y: [0, 1] },
      value: value,
      title: { text: "<b>Belly Button Washing Frequency</b><br>Scrubs per Week<br><b>(Digital Gauge)</b>" },
      textinfo: 'text',
      textposition: 'inside',
      type: "indicator",
      mode: "gauge+number",
...
var layout = {
   ...
   title: '<b>Belly Button Washing Frequency</b><br>Scrubs per Week<br><b>(Analogue Gauge)</b>',
   height: 600,
   width: 600,
